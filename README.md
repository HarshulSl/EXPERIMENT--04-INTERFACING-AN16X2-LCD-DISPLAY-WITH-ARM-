...
{
    Lcd_cursor(&lcd, 0, 1);
    Lcd_string(&lcd, "Name:HARSHUL SL\n");

    Lcd_cursor(&lcd, 1, 1);
    Lcd_string(&lcd, "212224230090\n");
}
...
{
  /* User can add printf for debugging here */
}
#endif
...
<img width="876" height="619" alt="image" src="https://github.com/user-attachments/assets/82a9858c-f1aa-4087-a0c3-5ef9f5b0da5c" />


 
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
<img width="1026" height="716" alt="image" src="https://github.com/user-attachments/assets/cbf9e9ff-30f1-41d8-a525-2f96cb0326cc" />
